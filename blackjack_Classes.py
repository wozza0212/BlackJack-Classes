...
def take_bet(chips):
    ...
    while True:
        try:
            chips.bet = int(input('How many chips would you like to stake'))
        except ValueError:
            print('Sorry, a stake must be an integer!')
        else:
...
def push(player, dealer):
    print('Dealer and player TIe, tis a push!')


while True:
    print('Welcome to Blackjack, You know the rules!')
